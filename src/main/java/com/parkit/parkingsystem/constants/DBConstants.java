...
public class DBConstants {
	...
	// Added to check if the vehicle registration number is already know in database when vehicle gets in
	public static final String GET_DUPLICATION_TICKET = "select count(*) from ticket where VEHICLE_REG_NUMBER=?";
}
